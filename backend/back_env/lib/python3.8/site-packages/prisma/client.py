...
SCHEMA_PATH = Path('/home/tobii/ALXOverflow/backend/prisma/schema.prisma')
PACKAGED_SCHEMA_PATH = Path(__file__).parent.joinpath('schema.prisma')
ENGINE_TYPE: EngineType = EngineType.binary
BINARY_PATHS = model_parse(BinaryPaths, {'queryEngine': {'debian-openssl-1.1.x': '/home/tobii/.cache/prisma-python/binaries/5.4.2/ac9d7041ed77bcc8a8dbd2ab6616b39013829574/node_modules/prisma/query-engine-debian-openssl-1.1.x'}, 'introspectionEngine': {}, 'migrationEngine': {}, 'libqueryEngine': {}, 'prismaFmt': {}})
...
class Prisma:
    ...
    answerthread: 'actions.AnswerThreadActions[models.AnswerThread]'
    ...
    def __init__(
        ...
        *,
        ...
        self.answerthread = actions.AnswerThreadActions[models.AnswerThread](self, models.AnswerThread)
    ...
    def _default_datasource(self) -> DatasourceOverride:
        return {
            'name': 'db',
            'url': OptionalValueFromEnvVar(**{'value': 'postgresql://postgres:admin123.@localhost:5432/alx_overflow', 'fromEnvVar': None}).resolve(),
        }
...
class Batch:
    ...
    answerthread: 'AnswerThreadBatchActions'
    ...
    def __init__(self, client: Prisma) -> None:
        ...
        self.answerthread = AnswerThreadBatchActions(self)
...
# NOTE: some arguments are meaningless in this context but are included
# for completeness sake
class AnswerThreadBatchActions:
    def __init__(self, batcher: Batch) -> None:
        self._batcher = batcher

    def create(
        self,
        data: types.AnswerThreadCreateInput,
        include: Optional[types.AnswerThreadInclude] = None
    ) -> None:
        self._batcher._add(
            method='create',
            model=models.AnswerThread,
            arguments={
                'data': data,
                'include': include,
            },
    ...
    def create_many(
        self,
        data: List[types.AnswerThreadCreateWithoutRelationsInput],
        *,
        skip_duplicates: Optional[bool] = None,
    ) -> None:
        if self._batcher._active_provider == 'sqlite':
    ...
    def delete(
        self,
        where: types.AnswerThreadWhereUniqueInput,
        include: Optional[types.AnswerThreadInclude] = None,
    ) -> None:
        self._batcher._add(
            method='delete',
    ...
    def update(
        self,
        data: types.AnswerThreadUpdateInput,
        where: types.AnswerThreadWhereUniqueInput,
        include: Optional[types.AnswerThreadInclude] = None
    ) -> None:
        self._batcher._add(
    ...
    def upsert(
        self,
        where: types.AnswerThreadWhereUniqueInput,
        data: types.AnswerThreadUpsertInput,
        include: Optional[types.AnswerThreadInclude] = None,
    ) -> None:
        self._batcher._add(
            method='upsert',
    ...
    def update_many(
        self,
        data: types.AnswerThreadUpdateManyMutationInput,
        where: types.AnswerThreadWhereInput,
    ) -> None:
        self._batcher._add(
            method='update_many',
            model=models.AnswerThread,
    ...
    def delete_many(
        self,
        where: Optional[types.AnswerThreadWhereInput] = None,
    ) -> None:
        self._batcher._add(
            method='delete_many',
            model=models.AnswerThread,
