...
class BaseQuestion(_PrismaModel):
    __prisma_model__: ClassVar[Literal['Question']] = 'Question'
...
class BaseAnswer(_PrismaModel):
    __prisma_model__: ClassVar[Literal['Answer']] = 'Answer'
...
class BaseAnswerThread(_PrismaModel):
    __prisma_model__: ClassVar[Literal['AnswerThread']] = 'AnswerThread'

    @classmethod
    def prisma(cls: Type[_PrismaModelT], client: Optional['Prisma'] = None) -> 'actions.AnswerThreadActions[_PrismaModelT]':
        from .client import get_client

        return actions.AnswerThreadActions[_PrismaModelT](client or get_client(), cls)
