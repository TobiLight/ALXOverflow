...
class UserActions(Generic[_PrismaModelT]):
    ...
    async def group_by(
        ...
        *,
        ...
        -------
        ```py
        # group User records by reputation_score values
...
class QuestionActions(Generic[_PrismaModelT]):
    ...
    async def find_many(
        ...
        # find the first 5 Question records ordered by the content field
    ...
    async def find_first(
        ...
        -------
        ```py
        # find the second Question record ordered by the author_id field
    ...
    async def find_first_or_raise(
        ...
        -------
        ```py
        # find the second Question record ordered by the created_at field
    ...
    async def group_by(
        ...
        *,
        ...
        -------
        ```py
        # group Question records by content values
        # and count how many records are in each group
